...
public class WebLoginPage {
    ...
    public void clickToLoginPage() {
        wait.until(ExpectedConditions.elementToBeClickable(clcToOpenLoginPage))
                .click();
    }

    public boolean isLoginPageDisplayed() {
        return wait.until(ExpectedConditions.visibilityOf(signInHeader))
                .isDisplayed();
    }
    ...
    public boolean isReportsAndSummaryVisible() {
        return wait.until(
                ExpectedConditions.visibilityOf(reportsAndSummaryText)
        ).isDisplayed();
    }
}
